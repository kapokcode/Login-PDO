...
<body class="login-background-blue">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php"><i class="fas fa-sign-in-alt"></i> Log in</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="flex-login-form">
        ...
        <form class="p-5 card login-card-custom" action="register_db.php" method="post">
            ...
            <button type="submit" class="btn btn-primary btn-block text-white" name="submit">Register</button>
